...
layui.use(['paging', 'form','laydate'], function() {
    ...
    paging.init({
        openWait: true,
        url: 'http://www.qugou.com/merchant/evaluation/notReply/list?v=' + new Date().getTime(), //地址
		elem: '#content', //内容容器
		params: { //发送到服务端的参数
			evaluationDate:$('#evaluation-notReply-form #evaluationDate').val(),
			userName:$('#evaluation-notReply-form #userName').val()
		},
		type: 'POST',
		tempElem: '#tpl', //模块容器
		pageConfig: { //分页参数配置
